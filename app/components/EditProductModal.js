...
export default function EditProductModal({ productId, onClose, refreshProducts }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(
                `https://inventory-app-backend-1avz.onrender.com/api/products/products/${productId}/`,
                formData,
                {
                    headers: {
